          ...
          builder: (context,state){
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("Shop Smarter - Login",style: LightTheme.pageTitle,),
                  SizedBox(height: 10,),
                  Text("Log in to Access Exclusive Deals and Simplify Your Shopping Experience",style: LightTheme.pageDesc,),
                  SizedBox(height: 24,),
                  Form(
                    key: _loginFormKey,
                      child: Column(
                    children: [
                      ...
                      TextFormField(
                        obscureText: _hidePassword,
                          ...
                          decoration: LightTheme.textFieldDecoration(
                              label: "Password", hintText:"Password",
                              iconData:Icons.password_outlined,
                              suffixIcon:_hidePassword?Icons.visibility_off_outlined: Icons.visibility_outlined,
                            onSuffixIconClicked: (){
                                setState(() {
                      ...
                      Row(
                        children: [
                          ...
                          Text("Remember Me"),
                          Spacer(),
                          Text("Forget Password?",style: LightTheme.navigationTextStyle),
                        ],
                      ),
                      SizedBox(height: 20,),
                      ...
                      SizedBox(height: 10,),
                      MyButton.secondaryButton(text: "Create Account", onTap: (){
